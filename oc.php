...
?>
<div id="hcd_title">
    <span>Outside Charity</span>
</div>
<div id="hcd_image">  
    
  <?php 
     $query=mysqli_query($db,"SELECT Img FROM fd ");       
     $count=1;
    if (mysqli_num_rows($query)>0) { 
        ...
        while ($row=mysqli_fetch_assoc($query)) {
            if($count == 1){
                ...
                <img src="admin/images/oc/'.$row["Img"].'" class="d-block w-100" alt="...">
              </div>';
              $count=2;
            }
            else{
...
<?php 
    ...
    <div class="image"><img src="admin/images/oc_con/'.$row["Img"].'" alt="tharun"></div>
