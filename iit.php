...
?>
<div id="hcd_title">
    <span>Innovative and Informative Team</span>
</div>
<div id="hcd_image">  
    
  <?php 
     $query=mysqli_query($db,"SELECT Img FROM iit ");       
     $count=1;
    if (mysqli_num_rows($query)>0) { 
        ...
        while ($row=mysqli_fetch_assoc($query)) {
            if($count == 1){
                ...
                <img src="admin/images/iit/'.$row["Img"].'" class="d-block w-100" alt="...">
              </div>';
              $count=2;
            }
            else{
...
<div id="hcd_info">
<b>Innovative and Informative Team (IIT)</b>
<br>
<span>
...
<?php 
    ...
    <div class="image"><img src="admin/images/iit_con/'.$row["Img"].'" alt="tharun"></div>
