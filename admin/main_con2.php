...
<div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <input type="text" name="titlehead" class="form-control" id="edit_titlehead">
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <label for="exampleInputEmail1">Title :</label>
    <input type="text" id="hcd_titlehead" name="ntitlehead" class="form-control">
    <label for="exampleInputEmail1">Link :</label>
...
<div id="display">
<table id="dtBasicExample" data-tab="main_con2" class="table table-striped table-hover  table-bordered">
