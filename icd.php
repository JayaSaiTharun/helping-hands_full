...
?>
<div id="hcd_title">
    <span>Internal Care Department </span>
</div>
<div id="hcd_image">  
    
  <?php 
     $query=mysqli_query($db,"SELECT Img FROM icd ");       
     $count=1;
    if (mysqli_num_rows($query)>0) { 
        ...
        while ($row=mysqli_fetch_assoc($query)) {
            if($count == 1){
                ...
                <img src="admin/images/icd/'.$row["Img"].'" class="d-block w-100" alt="...">
              </div>';
              $count=2;
            }
            else{
...
<div id="hcd_info">
<b>Internal Care Department (ICD)</b>
<br>
<span>
The main goal of the ICD is to support and assist the poor and needy. ICD is primarily concerned with students who are unable to manage their most basic necessities and living expenses. It offers disadvantaged and needy students financial aid to defray their living expenses and travel costs. Besides, it also facilitates students with physical and mobility impairments by providing washing machines, cycles and tricycles.
</span>
</div>
...
<?php 
    ...
    <div class="image"><img src="admin/images/icd_con/'.$row["Img"].'" alt="tharun"></div>
