...
?>
<div id="hcd_title">
    <span>Public Relations Department</span>
</div>
<div id="hcd_image">  
    
  <?php 
     $query=mysqli_query($db,"SELECT Img FROM prd ");       
     $count=1;
    if (mysqli_num_rows($query)>0) { 
        ...
        while ($row=mysqli_fetch_assoc($query)) {
            if($count == 1){
                ...
                <img src="admin/images/prd/'.$row["Img"].'" class="d-block w-100" alt="...">
              </div>';
              $count=2;
            }
            else{
...
<div id="hcd_info">
<b>Public Relations Department (PRD)</b>
<br>
<span>
It makes a little contribution toward off-campus people basic expenditures, and depending on the severity of the situation is, it may even exceed that amount. This certain marginal amount is set as per the constitution that we uphold.
</span>
</div>
...
<?php 
    ...
    <div class="image"><img src="admin/images/prd_con/'.$row["Img"].'" alt="tharun"></div>
